...
def replace_space(text):
    ...
    # Заменяем пробелы на неразрывные, если после пробела идет тире 
    ...
    # заменяем на нулевой пробел до процента
    result = re.sub(r'%', r'\\u2060%', result)
    ...
    # Заменяем Tinkoff Shop
    result = re.sub(r'Tinkoff Shop', r'Tinkoff\\u00A0Shop', result)
