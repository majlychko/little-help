#важно - не забыть поправить в коде, в подстановках код тоже заменяет сейчас пробелы на неразрывные, из-за этого портятся ссылки
#не нужно заменять на неразрывники если текст в формате: {{TEXT}}
