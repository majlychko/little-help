...
def replace_space(text):
    ...
    # наверное надо смотреть есть ли пробел до и после тире, и если пробела нет, то вокруг нужно поставить пробелы нулевой ширины (потому что бывают кейсы с диапазонами 20 000—40 000 ₽, XIX—XX века ну и тж, но в целом везде где тире без пробелов предполагается неразрывник (или бывает неразрывное тире, не нашла))
