...
def replace_space(text):
    ...
    # за которыми следует пробел (тут вопрос к Артуру, надо ли убрирать пробелы у ты мы вы)
    pattern = r'(\b\w{1,2}\b) '
    ...
    #ниже идут продукты тинька, Артур сказал неразрывники ставить в них, думаю просто ставить после слова тинькофф неразрвыник (тестирую
    #часто ли случаи когда это нерелевантно)
